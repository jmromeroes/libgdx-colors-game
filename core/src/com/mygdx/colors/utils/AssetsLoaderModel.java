...
public class AssetsLoaderModel{
	...
	private static HashMap<String, TiledMap> tiledMaps;
	...
	public AssetsLoaderModel(){		
		...
		this.tiledMaps = new HashMap<String, TiledMap>();
	}
	...
	public static HashMap<String, TiledMap> getTiledMaps() {
		return tiledMaps;
	}

	public static void setTiledMaps(HashMap<String, TiledMap> tiledMaps) {
		AssetsLoaderModel.tiledMaps = tiledMaps;
	}
	...
	{
		return AssetsLoaderModel.getTiledMaps().get(key);
	}
	
	public static void addTiledMap(String key,TiledMap map)
	{
		AssetsLoaderModel.tiledMaps.put(key, map);
	}
	
	public static boolean removeTiledMap(String key)
	{
		TiledMap map = AssetsLoaderModel.tiledMaps.get(key);
		if (map != null)
		{
			map.dispose();
			return true;
